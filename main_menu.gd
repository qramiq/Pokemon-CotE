...
func _ready() -> void:
	# Das Menü muss trotz get_tree().paused Eingaben empfangen.
...
func _unhandled_input(event: InputEvent) -> void:
	...
	# Mit Escape aus einem Untermenü zurückgehen
	# oder das komplette Menü schließen.
...
func open_menu() -> void:
	...
	var dialogue_ui: Node = get_tree().get_first_node_in_group(
		"dialogue_ui"
	)

	if dialogue_ui != null:
		if dialogue_ui.has_method("is_dialogue_open"):
